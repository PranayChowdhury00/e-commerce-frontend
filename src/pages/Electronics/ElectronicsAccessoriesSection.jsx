...
import { FaMobile, FaLaptop, FaHeadphones, FaApple, FaCamera } from 'react-icons/fa';
import { BsSmartwatch, BsDeviceHdd } from 'react-icons/bs';
import axios from 'axios';
import Swal from 'sweetalert2';
import { useContext } from 'react';
import { AuthContext } from '../AuthProvider/AuthProvider';

const ElectronicsAccessoriesSection = () => {
...
const email = user?.email;
  // Category icons
  const categoryIcons = {
    'all': <FaApple className="mr-2" />,
    'mobiles': <FaMobile className="mr-2" />,
    'laptops': <FaLaptop className="mr-2" />,
    'headphones': <FaHeadphones className="mr-2" />,
    'smartwatches': <BsSmartwatch className="mr-2" />,
    'cameras': <FaCamera className="mr-2" />,
    'accessories': <BsDeviceHdd className="mr-2" />
  };
  ...
  return (
    <section className="electronics-accessories py-12 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 md:mb-0">Premium Electronics</h2>
            ...
            {filteredProducts.map(product => (
              <div key={product.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="relative">
                  ...
                  >
                    <FiHeart className="w-5 h-5" fill={wishlist.includes(product._id) ? 'currentColor' : 'none'} />
                  </button>
                </div>
...
export default ElectronicsAccessoriesSection;