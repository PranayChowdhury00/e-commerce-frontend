...
const RefrigeratorsSection = () => {
  ...
  // Product categories
  const categories = [
    { id: 'all', name: 'All Refrigerators' },
    { id: 'french-door', name: 'French Door' },
    { id: 'side-by-side', name: 'Side-by-Side' },
    { id: 'bottom-freezer', name: 'Bottom Freezer' },
    { id: 'top-freezer', name: 'Top Freezer' },
    { id: 'counter-depth', name: 'Counter Depth' },
    { id: 'mini', name: 'Mini Fridges' },
    { id: 'wine-cooler', name: 'Wine Coolers' },
  ];
    ...
    <section className="electronics-deals py-12 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 md:mb-0">Smart Refrigerators</h2>
        ...
        {!loading && filteredProducts.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500">
              No refrigerators match your filters. Try adjusting your criteria.
            </p>
            <button
              onClick={() => {
